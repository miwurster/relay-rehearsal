...
/** What a todo list's notion of now is measured against. */
 ...
 *
 * Insertion order is the order todos were added, and the order a listing
 * comes back in when it is not asked for another; adding never reorders what
 * is already there.
 */
export class TodoList {
  ...
  /**
   * A clock may be given to measure overdue todos against; a list constructed
   * without one measures against the real one.
   */
   ...
   *
   * A due date may be given; a todo added without one is undated.
   */
  ...
  /** The todos the filter asks for, in the order the caller asked for. */
