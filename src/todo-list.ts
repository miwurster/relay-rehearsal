...
/** What a todo list measures "now" against. */
 ...
 * were added unless a listing asks for another order, and adding never
...
export class TodoList {
  ...
  /** Add a todo with the given title and an optional due date, and answer the todo that was added. Omitting the due date adds the todo undated. */
  ...
  /** The todos the filter asks for, in the given order. Defaults to the order they were added in. */
...
/** A copy of the todo, its due date cloned so a caller's mutation cannot reach the stored todo. */
...
/** Soonest due date first, every undated todo after every dated one, ties left in place for a stable sort. */
