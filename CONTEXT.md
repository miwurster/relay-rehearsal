...
**Due date**: when a **todo** is meant to be done, set only when the todo is added and never changed after.
...
**Due-date order**: a **listing** ordered soonest **due date** first, every **undated** todo after every dated one.
