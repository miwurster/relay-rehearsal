...
**Todo**: one thing somebody means to do, carrying an **id**, a **title**, its completion and, optionally, a **due date**.
...
A due date in the past is accepted: a todo already late is ordinary, not an error.
...
**Due-date order**: a **listing**'s todos soonest **due date** first, every **undated** todo after every dated one.
