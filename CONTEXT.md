...
Any filter can be asked for in this order; **insertion order** stays the default when none is given.
...
**Overdue**: a **todo** that is dated, open, and due before the **todo list**'s **clock**'s now, asked for as a **filter**.
